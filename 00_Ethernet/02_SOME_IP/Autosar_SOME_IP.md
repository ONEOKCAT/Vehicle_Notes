...
>&#8194;&#8195;Request IDs must not be reused until the response has arrived or is not expected to arrive anymore (timeout).
...
<img src=https://github.com/ONEOKCAT/Vehicle_Notes/blob/main/INSET/SOMEIP-String_Fixed_Length.png>
