...
&#8194;&#8194;&#8195;5. **ITM / Intermission 帧间隔**: DF（或 RF）通过帧间隔与上述各类帧进行分隔，但在错误帧和过载帧前不会插入帧间隔（严格讲并不算作一种帧类型）；
...
![image](https://github.com/ONEOKCAT/Vehicle_Notes/blob/main/INSET/CAN-Standard_Format_Data_Frame.png)
...
<img src="https://github.com/ONEOKCAT/Vehicle_Notes/blob/main/INSET/CAN-Extended_Format_Data_Frame.png" width="210px">
