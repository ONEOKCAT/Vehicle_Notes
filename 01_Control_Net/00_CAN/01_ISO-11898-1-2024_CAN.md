...
&#8194;&#8195;对于 EF 和 OF，按照以上 3.5.4 MAC 子层结构功能描述，EF 和 OF 的构建及收发仅发生在 MAC 子层，而不会往上传输；个人看法，EF 和 OF 的 bit 流，由 MAC 构建，且不会往上传输，但是“错误状态”和“过载状态”这类信息应该是可以在上层与 MAC 子层间进行传递的。
...
>
>&#8194;&#8195;The overload delimiter shall consist of eight recessive bits. After sending an overload flag, each node shall monitor the bus until it detects a recessive bit. At this point in time, every node shall finish sending its overload flag and all nodes shall start sending seven more recessive bits simultaneously, to complete the 8-bit overload delimite.
