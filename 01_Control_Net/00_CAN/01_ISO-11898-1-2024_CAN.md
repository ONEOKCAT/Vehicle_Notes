...
>&#8194;&#8194;Passive error flags initiated by a transmittershall cause error(s) (with two exceptions) at the receiver(s) when they start in a frame field encoded by the method of bit stuffing, **because then they lead to stuff errors detected by the receivers.** 
>
>&#8194;&#8194;The first exception is a passive error flag that starts during arbitration and another node continue stransmitting, and the second exception is a passive error flag that starts less than 6 bit before the end of the Frame-CRC sequence and the last bits of the CRC sequence happen to be all recessive.
>
