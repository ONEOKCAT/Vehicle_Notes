...
&#8194;&#8195;**ITM / Intermission 帧间隔 （或称 IFS /Interframe Space 帧间空间）**: DF（或 RF）通过帧间隔与上述各类帧进行分隔，但在错误帧和过载帧前不会插入帧间隔；

&#8194;&#8195;**Bus idle 总线空闲**: 总线无帧传输状态。
