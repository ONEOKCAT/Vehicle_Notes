...
### 4.4.5 &#8194;Services of LLC sub-layer

#### 4.4.5.1 &#8194;Service access points
...
#### 4.4.5.2 &#8194;Types of connectionless-mode transmission service
...
### 4.4.6 &#8194;Functions of the LLC sub-layer
...
#### 4.4.6.1 &#8194;Flow control on re-arbitration
...
#### 4.4.6.2 &#8194;Flow control on retransmission
...
#### 4.4.6.3 &#8194;Frame acceptance filtering
...
>
>&#8194;&#8195;The time-base shall be captured at time reference points signalled by the MAC sub-layer; the captured values shall be reported as time-stamps by the services L_Data.Confirm and L_Data.Indication.
>
...
### 4.5.2 &#8194;Services of the MAC sub-layer
...
### 4.5.4 &#8194;Functional model of MAC sub-layer architecture

### 4.5.5 &#8194;Specification of EF
