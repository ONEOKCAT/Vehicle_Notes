...
&#8194;&#8195;其中，ISO-11898是通信速度为5 kbps - 1 Mbps的CAN高速通信标准，规范中同时定义了数据链路层和高速物理层；  
&#8194;&#8195;ISO-11519是通信速度为 125kbps 以下的CAN低速通信标准，也就是容错CAN（LSFT-CAN）；提供从5 Kbit/s到125 Kbits/s的波特率；该标准允许在CAN总线连线失败时CAN总线通信得以继续进行。  
&#8194;&#8195;
