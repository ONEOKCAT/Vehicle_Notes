...
&#8194;&#8195;- **ADS / Arbitration-to-Dataphase Switch**：包含 4 bit，分别是 ADH，DH1，DH2 (前三者均为 1 bit 隐性位) 和 DL1 (1 bit 显性位)，且规定 AHD bit 后应切换为高速（数据）模式。
...
&#8194;&#8195;- **SEC / Simple Extended Content**: 1 bit, optional DLL security add-on.
...
&#8194;&#8195;- **PCRC / Preface CRC**: 13 bit for CRC_13 algorithm.
...
&#8194;&#8195;- **FCRC / Frame CRC**: 32 bit for CRC_32 algorithm.
...
&#8194;&#8195;- **FCP / Fromat Check Pattern**: 4 bit，包括 FCP3、FCP2 (2 bit 隐性位) 和 FCP1、FCP0 (2 bit 显性位)，且规定 FCP0 bit 后应切换为低速（仲裁）模式。
