...
&#8194;&#8195;**关于 CRC delimiter & ACK slot 的补充说明**：根据原文描述，CAN FD 中，对于接收节点，允许其利用最大两个位时间来识别 CRC delimiter 和 ACK slot 的有效性；个人认为可能是考虑到由高速波特率切换至低速波特率时，速率切换会导致时延。
