...
&#8194;&#8195;对于 CAN Transmitter 而言，为检测 Bit Error，采用了回读机制，即整个回读过程实现了从 CAN Controller (数字信号) -> CAN Transceiver TX (差分电平) -> Transceiver RX (差分电平) -> CAN Controller (数字信号) 的转换，必然导致了物理延迟。
